...
import {verifyRoutes, userRoutes, usersRoutes,logoutRoutes, ownerRoutes ,paymentRoutes, resetRoutes ,sendEmail ,termsRoutes ,favoriteRoutes ,adminRoutes  } from './router';
